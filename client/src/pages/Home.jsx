    ...
    <div className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-32 pb-24 w-full">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
          ...
          {/* Right — Photo */}
          <div className="flex-shrink-0 animate-fade-up stagger-2">
            <div className="relative">
              {/* Glow ring */}
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-br from-teal-400/30 to-teal-600/10 blur-sm" />
              <div className="relative w-64 h-80 md:w-72 md:h-96 rounded-2xl overflow-hidden border border-teal-400/20">
                <img
                  src="/passport_pic.png"
                  alt="Chirin Banu M"
                  className="w-full h-full object-cover object-top"
                />
              </div>
              {/* Badge */}
              <div className="absolute -bottom-4 -left-4 glass border border-white/10 rounded-xl px-4 py-2">
                <p className="font-mono text-teal-400 text-xs">CGPA</p>
                <p className="font-display text-white font-bold text-xl">8.15</p>
              </div>
              <div className="absolute -top-4 -right-4 glass border border-white/10 rounded-xl px-4 py-2">
                <p className="font-mono text-teal-400 text-xs">IEEE</p>
                <p className="font-display text-white font-bold text-xl">2025</p>
              </div>
            </div>
          </div>
